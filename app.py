...
def load_page(state: _SessionState, model: TextGenerationPipeline):
    ...
    While certain domains were removed, the model was trained on largely unfiltered content from the internt, which contains biased and discriminating language.
